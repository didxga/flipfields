(function($) {
   ...
   * @param options Configuration for customize the plugin
   */
  $.fn.flipFields = function(options) {
    ...
    flipFields.each(function() {
      ...
      var flipField = $(this);
      //if the DOM is eligible to use this plugin
      ...
      //temp variable to hold the original value
      var originalValue = flipField.val();
      //hide the element to give space for a <span> that acts as render of that input element
      flipField.hide();
      ...
      span.click(function(e) {
    	...
    	//set currentlyFlipped to the current iterated(Closure Is Used Here), save the current value to variable originalValue
